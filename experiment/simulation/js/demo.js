...
(function () {
        ...
        if(connections.length==0)
        {
            Swal.fire({
               ...
               position:'center',
                ...
                html: 'Please connect the components as mentioned below:<br>(1-3), (2-4), (5-7), (6-8), <br> (9-12), (10-11), (13-15), (14-16),<br> (17-18), (19-20)',
               icon:'error'
                });
               return false
        }
    ...
    jsPlumb.ready(function () {
        ...
        instance.batch(function () {
			...
			var exampleEndpoint6 = {
                endpoint: ["Dot", { radius: 15 }],
                paintStyle: { fill: "black" },
                isSource: true,
                scope: "green",
                connectorStyle: { stroke: "black", strokeWidth: 20 },
                connector: ["Bezier", { curviness: -10 } ],
                maxConnections:1 ,
                isTarget: true,
                dropOptions: exampleDropOptions
			...
			Point.push(instance.addEndpoint("dragDropWindow17", { anchor: [0.75, 0, 0, -1] }, exampleEndpoint6));
			Point.push(instance.addEndpoint("dragDropWindow18", { anchor: [0.75, 0, 0, -1] }, exampleEndpoint6));
			Point.push(instance.addEndpoint("dragDropWindow19", { anchor: [0.75, 0, 0, -1] }, exampleEndpoint6));
			Point.push(instance.addEndpoint("dragDropWindow20", { anchor: [0.75, 0, 0, -1] }, exampleEndpoint6));
